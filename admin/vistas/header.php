...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>FAB</b> A</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>PERSONAL</b></span>
    </a>
...
<div class="user-panel">
      ...
      <li><a href="inicio.php"><i class="fa  fa-user (alias)"></i> <span>Inicio</span></a></li>
      <li><a href="descripcion.php"><i class="fa  fa-user (alias)"></i> <span>Descripción</span></a></li>
...
?>
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="departamento.php"><i class="fa fa-circle-o"></i> Unidad</a></li>
          </ul>
      </li>

      <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Unidad</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
...
<li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>Novedades</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="rutinarias.php"><i class="fa fa-circle-o"></i> Rutinarias</a></li>
            <li><a href="sobresalientes.php"><i class="fa fa-circle-o"></i> Sobresalientes</a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>